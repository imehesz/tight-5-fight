...
func _ready() -> void:
	...
	add_spacer(box, 12)
	add_button(box, "PLAY", func(): GameState.change_scene(GameState.SCENE_CHARACTER_SELECT, true))
	add_button(box, "SETTINGS", func(): GameState.change_scene(GameState.SCENE_SETTINGS, true))
	add_button(box, "LEADERBOARD", func(): GameState.change_scene(GameState.SCENE_SCOREBOARD, true))
	add_button(box, "ABOUT", func(): GameState.change_scene(GameState.SCENE_ABOUT, true))
	add_spacer(box, 6)
